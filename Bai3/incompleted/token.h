...
#define KEYWORDS_COUNT 25  // Updated count
...
typedef enum {
  ...
  KW_BREAK, KW_CONTINUE,  // Added keywords
  KW_BYTES, // Added KW_BYTES
  KW_UNTIL, // Added KW_UNTIL
  SB_POWER, // Added SB_POWER
  SB_QUESTION, // Added SB_QUESTION
  SB_SEMICOLON, SB_COLON, SB_PERIOD, SB_COMMA,
  SB_ASSIGN, SB_EQ, SB_NEQ, SB_LT, SB_LE, SB_GT, SB_GE,
  SB_PLUS, SB_MINUS, SB_TIMES, SB_SLASH,
  SB_LPAR, SB_RPAR, SB_LSEL, SB_RSEL, SB_LSEL_2, SB_RSEL_2
} TokenType; 
