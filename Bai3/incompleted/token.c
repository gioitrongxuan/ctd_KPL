...
struct {
  ...
  {"FOR", KW_FOR},
  {"TO", KW_TO},
  {"BREAK", KW_BREAK},  // Added keywords
  {"CONTINUE", KW_CONTINUE},  // Added keywords
  {"BYTES", KW_BYTES},  // Added keywords
  {"UNTIL", KW_UNTIL},  // Added keywords
  {"POWER", SB_POWER}  // Added keywords
};
...
char *tokenToString(TokenType tokenType) {
  ...
  case KW_BREAK: return "keyword BREAK";  // Added keywords
  case KW_CONTINUE: return "keyword CONTINUE";  // Added keywords
  case KW_BYTES: return "keyword BYTES";  // Added keywords
  case KW_UNTIL: return "keyword UNTIL";  // Added keywords
  case SB_POWER: return "keyword POWER";  // Added keywords
  ...
  case SB_RPAR: return "\')\'";
  case SB_LSEL: return "\'(.\'";
  case SB_LSEL_2: return "\'[\'";
  case SB_RSEL_2: return "\']\'";
  case SB_RSEL: return "\'.)\'";
  default: return "";
  }
}
