...
Token* getToken(void) {
  ...
  //
  case CHAR_LBRACKET:
    token = makeToken(SB_LSEL_2, lineNo, colNo);
    readChar(); 
    return token;
  case CHAR_RBRACKET:
    token = makeToken(SB_RSEL_2, lineNo, colNo);
    readChar(); 
    return token;
  //
  case CHAR_LPAR:
...
void printToken(Token *token) {
  ...
  case KW_CONTINUE: printf("KW_CONTINUE\n"); break;
  ...
  case SB_LSEL_2: printf("SB_LSEL_2\n"); break;
  case SB_RSEL_2: printf("SB_RSEL_2\n"); break;
  }
}
